    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_on', models.DateTimeField()),
                ('status', models.CharField(choices=[(web_app.models.OrderStatusType('created'), 'created'), (web_app.models.OrderStatusType('approved'), 'approved'), (web_app.models.OrderStatusType('en_rout'), 'en_rout'), (web_app.models.OrderStatusType('stored'), 'stored'), (web_app.models.OrderStatusType('delivered'), 'delivered')], max_length=20)),
